...
function setSchedule() {
    ...
    renderRecordsCount(settings.recordsCount);
}
...
function renderRecordsCount(count) {
    document.getElementById('entry-point').style.height = document.querySelector('#entry-point table td').clientHeight * count + 'px';
}
...
function applyAndSaveSettings(){
    ...
    renderRecordsCount(recordsCount);
...
document.addEventListener("DOMContentLoaded", function(){
    setSchedule();
    setInterval(setSchedule, 120000);
